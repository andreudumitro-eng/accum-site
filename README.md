...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ACCUM — The First Fair Proof‑of‑Work Blockchain for Miners & Investors</title>
    <meta name="description" content="The first blockchain with accumulative mining: every miner gets paid every block. Fair Proof‑of‑Work, concave rewards, PoCI, Shard Streams, ultra‑light nodes. For investors and miners.">
    <style>
        /* Те же стили, что в русской версии (можно скопировать из русского файла) */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
            background-color: #0b0e11;
...
<body>
    <div class="lang-switch">
        <a href="/">RU</a> | <a href="/en/" class="active">EN</a>
    </div>
    <div class="container">
        <header>
            <h1>ACCUM</h1>
        ...
        <!-- Two audiences: investors and miners -->
        <section>
            <h2 style="font-size: 2rem; margin-bottom: 1rem; color: #f3b229; text-align: center;">Who is ACCUM for</h2>
            <div class="grid-2">
                <div class="card">
                    <div class="emoji-big">📈</div>
                    <h3>Investors</h3>
                    <p>Early entry into a project with unique economics. Shard Streams — passive income from mining. Transparent tokenomics, 80% of coins go to miners, creating healthy demand.</p>
                    <p><strong>Contact us:</strong> investment memorandum available on request.</p>
                </div>
                <div class="card">
                    <div class="emoji-big">⛏️</div>
                    <h3>Miners</h3>
                    <p>Stable income every block, not a lottery. Concave rewards protect against whales. Ultra‑light nodes allow mining even on a phone. Join the testnet!</p>
                    <p><strong>Want to test?</strong> Write to us.</p>
                </div>
            </div>
        </section>
        ...
        <!-- Five innovations -->
        <section>
            <h2 style="font-size: 2rem; margin-bottom: 1rem; color: #f3b229;">🔷 5 innovations — 0 competitors</h2>
            <div class="features-grid">
                <div class="feature-card">
                    <span class="feature-number">01</span>
                    <h3>Accumulative Mining</h3>
                    <p>Every miner gets paid every block. No lottery — stable salary-like income.</p>
                </div>
                <div class="feature-card">
                    <span class="feature-number">02</span>
                    <h3>Concave Rewards</h3>
                    <p>Logarithmic curve: 10× hashrate → ~3× reward. 51% attacks become economically irrational.</p>
                </div>
                <div class="feature-card">
                    <span class="feature-number">03</span>
                    <h3>PoCI (Sybil resistance)</h3>
                    <p>Proof-of-Contribution-and-Identity: hashrate, uptime, verification, age. 1000 fake nodes < 1 real node.</p>
                </div>
                <div class="feature-card">
                    <span class="feature-number">04</span>
                    <h3>Shard Streams</h3>
                    <p>Hashrate futures — tokenization of future rewards. Miners get liquidity today, investors get passive income.</p>
                </div>
                <div class="feature-card">
                    <span class="feature-number">05</span>
                    <h3>Ultra‑Light Nodes</h3>
                    <p>Full verification with 50 MB state. Sync in 5 minutes. Runs on phones, routers, Raspberry Pi.</p>
                </div>
            </div>
        </section>

        <!-- Contact block with prominent email -->
        <div class="contact-block">
            <h2>Contact us</h2>
            <div class="contact-email">
                📧 <a href="mailto:andreudumitro@gmail.com">andreudumitro@gmail.com</a>
            ...
            <p style="color: #b0baca; max-width: 500px; margin: 1.5rem auto;">
                For all inquiries: investments, partnerships, testing, ideas. We reply within 24 hours.
            </p>
            <div class="contact-links">
                <a href="https://twitter.com/Andredumitro" target="_blank" rel="noopener">🐦 Twitter</a>
                <a href="https://github.com/andreudumitro-eng" target="_blank" rel="noopener">💻 GitHub</a>
        ...
        <!-- Docs block -->
        <div class="links-panel">
            <h2>Whitepaper & Source Code</h2>
            <p>Full technical specification and Rust prototype are available in the open repository.</p>
            <div class="button-group">
                <a href="https://github.com/andreudumitro-eng/ACCUM" class="button" target="_blank" rel="noopener">📦 GitHub</a>
                <a href="https://github.com/andreudumitro-eng/ACCUM/blob/main/whitepaper/en/ACCUM_whitepaper_v2.0_en.md" class="button button-outline" target="_blank" rel="noopener">🇬🇧 Whitepaper (EN)</a>
                <a href="https://github.com/andreudumitro-eng/ACCUM/blob/main/whitepaper/ru/ACCUM_whitepaper_v2.0_ru.md" class="button button-outline" target="_blank" rel="noopener">🇷🇺 Whitepaper (RU)</a>
        ...
        <footer>
            <p>© 2026 Andrii Dumitro — ACCUM. Fair Proof‑of‑Work.</p>
            <p style="margin-top: 0.8rem;">🌐 <a href="https://accum.site">accum.site</a> — official domain. Site under construction.</p>
        </footer>
    </div>
</body>
</html>
